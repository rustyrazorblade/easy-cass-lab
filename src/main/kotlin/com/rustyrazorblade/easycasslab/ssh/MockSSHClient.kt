...
class MockSSHClient : ISSHClient {
    ...
    override fun downloadDirectory(remoteDir: String, localDir: File, includeFilters: List<String>, excludeFilters: List<String>) {
        log.debug { "MOCK: Downloading directory from $remoteDir to ${localDir.absolutePath} with includeFilters: $includeFilters, excludeFilters: $excludeFilters" }
    ...
    override fun getScpClient(): CloseableScpClient {
        return object : CloseableScpClient {
            override fun upload(local: Path, remote: String, vararg options: ScpClient.Option) {}
            override fun upload(locals: Array<out Path>, remote: String, options: Collection<ScpClient.Option>) {}
            override fun upload(
                p0: InputStream?,
                p1: String?,
                p2: Long,
            ...
            override fun upload(locals: Array<out String>, remote: String, options: Collection<ScpClient.Option>) {}
            override fun getClientSession(): ClientSession {
                TODO("Not yet implemented")
            }

            override fun download(p0: String?, p1: String?, p2: MutableCollection<ScpClient.Option>?) {
                TODO("Not yet implemented")
            }

            override fun download(remote: String, local: Path, vararg options: ScpClient.Option) {}
            override fun download(p0: String?, p1: Path?, p2: MutableCollection<ScpClient.Option>?) {
                TODO("Not yet implemented")
            }

            override fun download(p0: String?, p1: OutputStream?) {
                TODO("Not yet implemented")
            }

            override fun download(p0: Array<out String>?, p1: String?, p2: MutableCollection<ScpClient.Option>?) {
                TODO("Not yet implemented")
            }

            override fun download(remotes: Array<out String>, local: Path, options: Collection<ScpClient.Option>) {}
            override fun close() {}
