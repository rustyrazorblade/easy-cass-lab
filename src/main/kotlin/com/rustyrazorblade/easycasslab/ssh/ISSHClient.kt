...
interface ISSHClient {
     ...
     */
    fun uploadFile(local: Path, remote: String)
     ...
     */
    fun downloadFile(remote: String, local: Path)
     ...
     */
    fun downloadDirectory(remoteDir: String, localDir: File, includeFilters: List<String> = listOf(), excludeFilters: List<String> = listOf())
