...
internal class EC2ServiceTest {
    ...
    fun `listPrivateAMIs should filter by owner and name pattern`() {
        ...
        val result = ec2Service.listPrivateAMIs("rustyrazorblade/images/easy-db-lab-*")

        assertThat(result).hasSize(1)

        val ami = result[0]
        assertThat(ami.id).isEqualTo("ami-111")
        assertThat(ami.name).isEqualTo("rustyrazorblade/images/easy-db-lab-cassandra-amd64-20240101")
    ...
    fun `listPrivateAMIs should convert x86_64 architecture to amd64`() {
        val testImage =
            Image
                .builder()
                .imageId("ami-111")
                .name("rustyrazorblade/images/easy-db-lab-base-amd64-20240101")
                .architecture("x86_64")
                .creationDate("2024-01-01T00:00:00.000Z")
                .ownerId("123456789012")
    ...
    fun `listPrivateAMIs should keep arm64 architecture unchanged`() {
        val testImage =
            Image
                .builder()
                .imageId("ami-111")
                .name("rustyrazorblade/images/easy-db-lab-base-arm64-20240101")
                .architecture("arm64")
                .creationDate("2024-01-01T00:00:00.000Z")
                .ownerId("123456789012")
                .blockDeviceMappings(emptyList())
    ...
    fun `should build correct filter for listPrivateAMIs`() {
        ...
        ec2Service.listPrivateAMIs("rustyrazorblade/images/easy-db-lab-*")
        ...
        assertThat(filter.values()).containsExactly("rustyrazorblade/images/easy-db-lab-*")
    }
}
