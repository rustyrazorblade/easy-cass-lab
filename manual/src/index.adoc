...
If you are looking for a tool to aid in benchmarking these clusters please see the companion project http://rustyrazorblade.com/tlp-stress/[tlp-stress].
...
If you've never used to the tool before, the first time you run a command you'll be asked to supply some information, which will generate a configuration file which will be placed in your `$HOME/.easy-cass-lab/profiles/default/settings.yaml`.
...
They get output here: `src/main/resources/com/rustyrazorblade/easycasslab/commands/origin/provisioning/monitoring/config/grafana/dashboards`
