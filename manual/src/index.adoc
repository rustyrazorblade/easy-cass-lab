...
easy-cass-lab includes a Model Context Protocol (MCP) server that allows seamless integration with Claude Code. This enables Claude to directly interact with your easy-cass-lab clusters and perform operations through a standardized protocol.
...
The MCP server provides Claude with direct access to easy-cass-lab operations, allowing for:
...
* **Direct Control**: Claude can execute easy-cass-lab commands directly without manual intervention
